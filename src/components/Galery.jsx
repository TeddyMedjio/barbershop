...
const Galery = () => {
  return (
    <div className="bg-black-gray relative pb-20">
      <div className=" absolute top-0 h-32 bg-gradient-to-b from-black-gray w-full"></div>
      <div className=" absolute bottom-20 h-32 bg-gradient-to-t from-black-gray w-full"></div>
